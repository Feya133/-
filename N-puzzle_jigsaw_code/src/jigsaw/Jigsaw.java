...
public abstract class Jigsaw {
    ...
    public Queue<JigsawNode> getOpenList(){
        return exploreList;
    }
    public Set<JigsawNode> getCloseList(){
        return visitedList;
    }
    public void setOpenList(Queue<JigsawNode> ol){
        this.exploreList=ol;
    }
    public void setCloseList(Set<JigsawNode> cl){
        this.visitedList=cl;
    }
    public void setSearchedNodesNum(int num){
        this.searchedNodesNum=num;
    }
